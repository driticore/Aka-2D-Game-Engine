...
//Find the second pattern after #type 'pattern'
    ...
    public void uploadMat4f(String varName, Matrix4f mat4) {
        // varLocation is an integer variable that stores the location of a uniform variable in a shader program, retrieved using the glGetUniformLocation function.
        int varLocation = glGetUniformLocation(shaderProgramID, varName);
        use();
        FloatBuffer mat4Buffer = BufferUtils.createFloatBuffer(16);

        mat4.get(mat4Buffer); //Turns our matrices into 1D array
        glUniformMatrix4fv(varLocation, false, mat4Buffer); // transpose = linear algebraic function
    }
